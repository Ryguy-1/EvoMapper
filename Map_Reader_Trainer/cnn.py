...
# 4 frames per kernel (kernel size 12 x 4)
class CNN:
    ...
    def __init__(self):
        ...
        self.model.add(layers.Conv2D(96, (12, 4), strides=(6, 1), activation=None, input_shape=self.input_shape, data_format='channels_first'))
        self.model.add(layers.Activation('relu'))
        self.model.add(layers.BatchNormalization())
        assert self.model.output_shape == (None, 96, 499, 1)
        # Pool
        ...
        # Convolution 2
        self.model.add(layers.Conv2D(64, (6, 1), strides=(3, 1), activation=None, data_format='channels_first'))
        self.model.add(layers.Activation('relu'))
        self.model.add(layers.BatchNormalization())
        assert self.model.output_shape == (None, 64, 166, 1)
        # Pool
        self.model.add(layers.MaxPool2D(pool_size=(2, 1), strides=(2, 1), data_format='channels_first'))
        assert self.model.output_shape == (None, 64, 83, 1)
        # Dropout
